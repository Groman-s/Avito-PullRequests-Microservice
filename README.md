...
Порт и другие настройки можно изменить через файл переменных окружения `.env` в корневой папке проекта.
___
...
50 запросов в секунду в течение 2 часов.

#### **___Краткая сводка___**:
* Среднее время ответа: 8 мс
* SLI успешности: 100%
* 99% запросов выполнились быстрее 37 мс
